class OllamaClient {
     ...
     * Erwartet, dass Backend an /api/chat/:chatId lauscht, und die Struktur korrekt an Ollama mappen kann.
     * @param {string} chatId
     * @param {array} messages - Array von Objekten: { role: "user"|"assistant"|"system", content: "..." }
     * @param {string} model
     * @returns {Promise<object>}
     */
    async sendMessage(chatId, messages, model) {
        try {
    ...
    async summarizeConversation(chatId, messages, model) {
        try {
            ...
            if (!response.ok) {
                const errorText = await response.text();
                throw new Error(`Failed to summarize conversation: ${response.status} – ${errorText}`);
            }
            return await response.json();
        } catch (error) {
    ...
    async getSystemPrompts() {
        try {
            ...
            if (!response.ok) throw new Error(`Failed to fetch system prompts: ${response.status}`);
            return await response.json();
        } catch (error) {
    ...
    async createSystemPrompt(prompt) {
        try {
            ...
            if (!response.ok) throw new Error(`Failed to create system prompt: ${response.status}`);
            return await response.json();
        } catch (error) {
    ...
    async updateSystemPrompt(id, prompt) {
        try {
            ...
            if (!response.ok) throw new Error(`Failed to update system prompt: ${response.status}`);
            return await response.json();
        } catch (error) {
    ...
    async deleteSystemPrompt(id) {
        try {
            ...
            if (!response.ok) throw new Error(`Failed to delete system prompt: ${response.status}`);
            return await response.json();
        } catch (error) {
    ...
    async getChatStates() {
        try {
            ...
            if (!response.ok) throw new Error('Failed to fetch chat states');
            return await response.json();
        } catch (error) {
    ...
    async updateChatStates(chatStates) {
        try {
            ...
            if (!response.ok) throw new Error('Failed to update chat states');
            return await response.json();
        } catch (error) {
            console.error('Error updating chat states:', error);
            throw error;
        }
    }
